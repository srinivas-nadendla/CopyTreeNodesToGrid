...
folder are mapped to the application's root namespace, 'CopyTreeNodesToGrid'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CopyTreeNodesToGrid"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CopyTreeNodesToGrid' in the same way
as `"CopyTreeNodesToGrid/sass/src"`.
